...
class Picking(models.Model):
    ...
    def action_send_mail(self):
        self.ensure_one()
        template = self.env.ref('dynco_base.mail_template_data_delivery_send_by_mail', raise_if_not_found=False)
...
class Location(models.Model):
    ...
    warehouse_sector = fields.Char(string='Warehouse Sector')
...
class StockRule(models.Model):
    ...
    def _run_buy(self, procurements):
        ...
        for procurement, rule in procurements:
            print (">>>>>>>>>>", procurement.values.get('partner_id'))
            ...
            if procurement.values.get('supplierinfo_id'):
                ...
                supplier = procurement.product_id.with_company(procurement.company_id.id).with_context(customer_id=procurement.values.get('partner_id'))._select_seller(
